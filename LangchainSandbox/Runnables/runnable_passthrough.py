...
template1 = PromptTemplate(
    template="Explain the concept '{topic}' in approx 50 words.",
...
template2 = PromptTemplate(
    template="Explain the concept '{text}' to an infant in approx 50 words.",
    input_variables=["text"],
)
chain2 = RunnableSequence(template2, model2, parser)

# parallel chain
parallel_chain = RunnableParallel({"og": RunnablePassthrough(), "infant": chain2})
